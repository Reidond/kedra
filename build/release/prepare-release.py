...
require(set(candidate) == {'schema_version', 'project', 'scope', 'source_revision', 'build',
                          ...
                          'fresh_install_qualified', 'last_successful_resolution'}, 'Unknown or missing candidate field')
...
release.update(sequence=sequence, approval='promoted', minimum_protocol=1)
...
(args.output / 'release.json').write_bytes(release_bytes)
(args.output / 'checkpoint.json').write_bytes(checkpoint_bytes)
