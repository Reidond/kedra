...
CONTEXT = ROOT / "build/research/refresh"
...
def main():
    if os.environ.get("GITHUB_ACTIONS") != "true" or os.environ.get("GITHUB_REF") != "refs/heads/codex/usable-system":
    ...
    public.mkdir()
    try:
        inputs = read(ROOT / "build/research/inputs.json")
