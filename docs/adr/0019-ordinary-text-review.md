...
2026-09-08. Implemented for qualification; R03 remains open pending actual CLI
and native results. Initial adapter: `.config/niri/config.kdl` only. No live file
