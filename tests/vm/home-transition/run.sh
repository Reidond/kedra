...
python3 tests/vm/home-transition/prepare.py images
...
python3 tests/vm/home-transition/prepare.py requests
...
for phase in stage-b accept-b rollback-a; do
    ...
    xvfb-run -a -s '-screen 0 1280x768x24' env LIBGL_ALWAYS_SOFTWARE=1 \
        python3 tests/vm/desktop/run_vm.py --disk "${disks[0]}" --persistent-disk --network \
