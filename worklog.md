...
| Latest verified check | Workspace 34226367439 and older-media enrollment/update/rollback 34226367288 pass at 71916b9; native desktop/discard/doctor 34223972271 passes at a5cd96e. E2E/manual-only testing applies. Signed-payload ISO 34222699188 completes a fresh encrypted installation and retains the sentinel identically; ISO-free first boot is underway. |
...
| Current task | Owner requested full implementation through usable installation. Fresh desktop health and native Noctalia discard/doctor pass. Preparing fresh installation of the signed-payload research ISO and qualifying enrollment from older signed media. Production signing/promotion and generic file integration remain active work. No promoted owner media exists. |
