...
| Implemented | Three-package flat Rust workspace; source plan/archive; signed metadata verification and multipart ISO assembly; private SQLite state; native Noctalia review/export/activation/recovery; niri line/hunk review and Git publication; installed desktop diagnostics; private Codex runtime and Bitwarden integration. Niri native qualification, text activation, broader baseline transitions and production release setup remain unfinished. |
...
| Latest verified check | Workspace 34233086757 at 86bb96b passes Linux Clippy, actual niri/Noctalia CLI publication and installer assembly/interoperability. Desktop 34230166262 at 3267e03 passes killed-CLI recovery, default state, bounded portal/keyring and doctor; niri native run 34233086974 is pending. Signed helper 34228725707 passes at 94678f6. Signed-payload ISO 34222699188 passes fresh encrypted installation, ISO-free healthy desktop, strict policy and sentinel retention. |
...
| R03 | Native Noctalia capture/staging/local policy and selected-field publication pass. Niri adjacent line selection, exact-local policy, later edits, Git publication/receipts, insertion/deletion and symlink refusal pass the actual Linux CLI workflow. Native niri and text apply/discard remain open. See docs/research/R03-home-review/REPORT.md. |
...
Inspect the running native niri workflow, then finish safe text activation and
