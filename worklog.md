...
- Checks / evidence: pass — signed native round-trip regression 34253906774, required CI, exact merge/source and protection readback. in-progress — replacement candidate build. not-run — replacement image signing, production ISO, installation and promotion.
