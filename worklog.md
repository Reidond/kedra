...
| Implemented | Three-package flat Rust workspace; source planning; signed release verification/ISO assembly; private state; native Noctalia review/export/activation/recovery; native niri line review/publication and source reconciliation preview; desktop diagnostics; private Codex and Bitwarden. Niri discard is being qualified. Broader baseline transitions and production release setup remain unfinished. |
...
| Latest verified check | Workspace 34235455512 at 3c948aa passes Linux Clippy, actual source-reconciliation/publication CLI and release assembly/interoperability. Native niri review and full desktop pass 34233086974 at 86bb96b; 3c948aa native regression 34235455502 is pending. Signed helper 34228725707 and signed-payload ISO 34222699188 pass their documented scopes. New discard implementation is not yet qualified. |
...
| R03 | Native Noctalia review/publication and niri line/local decisions pass. Niri publication, source receipts, insertion/deletion and source-ancestry reconciliation pass actual Linux CLI workflows. Discard/native reload qualification and broader baseline activation remain open. See docs/research/R03-home-review/REPORT.md. |
...
Qualify native niri discard/reload and recovery, then finish baseline activation and
