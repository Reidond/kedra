...
| Implemented | Three-package flat Rust workspace; committed-source plan/archive; signed release/checkpoint verification; synthetic line/Noctalia disposition models; private Linux SQLite storage; Linux ordinary-user agent launchers with native Codex runtime/profile probes. Helper and real-home/deployment operations remain unavailable. |
...
| Latest verified check | Source afb8a67 passed [workspace 34184975775](https://github.com/Reidond/kedra/actions/runs/34184975775) and [desktop 34184975810](https://github.com/Reidond/kedra/actions/runs/34184975810): 64 Linux tests plus 1 doctest, standard checks, graphical login/services/keyring/native projection and full-resolution captures. Native Codex matrix/signatures passed [34182776503](https://github.com/Reidond/kedra/actions/runs/34182776503) at 43873cb. |
...
| Current task | Owner requested full implementation through usable installation. R02 diagnostic UI reaches deliberate disk/encryption planning but has not installed; source-guarded Anaconda local-payload/admin fixes are building in run 34185915639 at cfc956d. Actual installation uses rebuilt media and must prove enforcing desktop boot and sentinel retention. No promoted owner media exists. |
