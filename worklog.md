...
| Implemented | Three-package flat Rust workspace; source planning; signed release verification/ISO assembly; private state; native Noctalia review/export/activation/recovery; native niri line review/publication/reconciliation and discard/recovery; desktop diagnostics; private Codex and Bitwarden. Installed niri baseline acceptance is being qualified. Broader transitions and production release setup remain unfinished. |
...
| Latest verified check | Workspace 34237287689 and native desktop 34237287511 pass at 5e238c7: actual CLI reconciliation/publication, release checks, niri discard/relative includes/killed-CLI recovery and full desktop/doctor. Signed helper 34228725707 and signed-payload ISO 34222699188 pass their documented scopes. Installed-baseline acceptance is prepared for qualification. |
...
| R03 | Native Noctalia and niri review/discard/recovery pass. Niri publication, source receipts, insertion/deletion and source-ancestry reconciliation pass actual Linux CLI workflows. Installed-baseline acceptance and broader group behavior remain open. See docs/research/R03-home-review/REPORT.md. |
...
| Current task | Owner requested full implementation through usable installation. Signed research installation, older-media enrollment, multipart ISO assembly and native Noctalia interruption recovery pass. Qualifying ordinary niri line review; text activation and production signing/promotion remain active work. No promoted owner media exists. |
...
Qualify installed niri baseline acceptance and actual changed-image transitions, then finish
production signing/promotion. Preserve the
