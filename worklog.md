...
| Latest verified check | Workspace 34242602461 and signed helper 34242602458 pass at 3d29689. Native desktop 34238949306 passes installed niri baseline acceptance at 9802b49; driver-default regression 34240940795 passes at 967fd93. Signed-payload ISO 34222699188 passes its documented installation scope. A/B/A 34240940931 stages/boots B but fails the fixture's remembered-login handling; corrected run 34243567959 is pending. |
...
| R03 | Native Noctalia and niri review/discard/recovery pass. Niri publication, source receipts, insertion/deletion, source-ancestry reconciliation and current installed-baseline acceptance pass actual CLI/native workflows. Changed-image acceptance and broader groups remain open. See docs/research/R03-home-review/REPORT.md. |
...
| Current task | Owner requested full implementation through usable installation. Qualifying actual signed graphical A/B/A home transitions and preparing isolated production build/sign/installer jobs. Authority/recovery provisioning, exact production-media qualification and promotion remain active work. No promoted owner media exists. |
...
Finish the corrected actual changed-image transition and shared installer regression,
then finish production authority/recovery and signing/promotion. Preserve the
